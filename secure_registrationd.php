...
$conf_password = rtrim($conf_password);
 ...
 if($firstname=="" ){
	...
	if ($password != $conf_password) {
		...
		$sql1          = "INSERT INTO users (username,password,usertype) VALUES('$username','$password','2') ";
		
		if($result1 = mysqli_query($link, $sql1)){

			$userid = mysqli_insert_id($link);
			$sql2          = "INSERT INTO distributors_data (id, first_name,last_name,phone) VALUES('$userid','$firstname','$lastname','$phone') ";
